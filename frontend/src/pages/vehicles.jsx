        ...
        <div className="md:flex">
          <div className='w-full'>
            ...
            ">
                    ...
                    <td className='justify-center p-3'>                      <div className=''>
                      {doc?.chasisNumber}
                    </div></td>
                    <td className='justify-center p-3'>{doc?.manufactureCompany}</td>
                    <td className='justify-center p-3'>{doc?.price}</td>
                    <td className='justify-center p-3'>{doc?.manufactureYear}</td>
                    <td className='justify-center p-3'>
                      <div className="flex">
                        <div onClick={() => { setSelectedVehicle({ modelName: doc.modelName, price: doc.price,manufactureYear: doc.manufactureYear, chasisNumber: doc.chasisNumber, manufactureCompany: doc.manufactureCompany}); setSelectedVehicleId(doc._id); toggleModal(); }} className='status cursor-pointer rounded mr-2 p-5'>
                          Update
                        </div>
                        <div onClick={() => { setIsDeleting(true); setSelectedVehicleId(doc._id); toggleModal() }} className='status cursor-pointer rounded p-5'>
                          Delete
                        </div>
                      </div>
                    </td>
