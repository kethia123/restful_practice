...
function VehicleCarOwners() {
  ...
  return (
    <div className="pl-10 pt-10">
      <div>
        <div className="title">Vehicle Ownership Table</div>
          ...
          <div className="w-full">
            <div className="md:flex">
              <div>
                <button onClick={toggleModal} className="requestRegNum flex">
                  ...
                  <div className="mt-1">Create a new vehicle car owner</div>
                </button>
              </div>
            ...
            "
                    >
                      ...
                      <td className="justify-center p-3">{doc?.vehicle.price}</td>
                      <td className="justify-center p-3">{doc?.vehiclePlateNumber}</td>
                      <td className="justify-center p-3">
                        {((date) => {
                          return `${date.getDate()}/${
                            date.getMonth() + 1
                      ...
                      <td className="justify-center p-3">
                        <div className="flex">
                          <div
                            ...
                            className="status cursor-pointer rounded mr-2 p-5"
                          >
                            Update
                          </div>
                          <div
                            ...
                            className="status cursor-pointer rounded p-5"
                          >
                            Delete
                          </div>
                        </div>
