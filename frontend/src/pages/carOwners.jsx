        ...
        <div className="md:flex">
          <div className='w-full'>
            ...
            ">
                    ...
                    <td className='justify-center p-3'>{doc?.nationalId}</td>
                    <td className='justify-center p-3'>
                      <div className="flex">
                        <div onClick={() => { setSelectedCarOwner({ names: doc.names, address: doc.address, phone: doc.phone, nationalId: doc.nationalId}); setSelectedCarOwnerId(doc._id); toggleModal(); }} className='status cursor-pointer rounded mr-2 p-5'>
                          Update
                        </div>
                        <div onClick={() => { setIsDeleting(true); setSelectedCarOwnerId(doc._id); toggleModal() }} className='status cursor-pointer rounded p-5'>
                          Delete
                        </div>
                      </div>
                    </td>
      ...
      <Modal ref={childRef} width="767px">
        {isDeleting ? <div>
          <div className="modal-title text-center my-10">
            Are you sure you want to delete the selected car owner ?
          </div>
